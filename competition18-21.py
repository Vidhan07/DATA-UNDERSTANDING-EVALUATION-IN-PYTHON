...
with open('C:\\Users\Shashi Suman\Desktop\Data Analytics\Longitude_502.csv','rt') as l:
    data=csv.reader(l)
    for row in data:
       long.append(float(row[0]))
       container_y.append(float(row[0]))
with open('C:\\Users\Shashi Suman\Desktop\Data Analytics\Latitude_502.csv','rt') as l:
    data=csv.reader(l)
    for row in data:
       lat.append(float(row[0]))
       container_x.append(float(row[0]))

with open('C:\\Users\Shashi Suman\Desktop\Data Analytics\Latitude_601.csv','rt') as l:
    data=csv.reader(l)
    for row in data:
       lat1.append(float(row[0]))
       container_x.append(float(row[0]))
with open('C:\\Users\Shashi Suman\Desktop\Data Analytics\Longitude_601.csv','rt') as l:
    data=csv.reader(l)
    for row in data:
       long1.append(float(row[0]))
       container_y.append(float(row[0]))
with open('C:\\Users\Shashi Suman\Desktop\Data Analytics\Latitude_701.csv','rt') as l:
    data=csv.reader(l)
    for row in data:
       lat2.append(float(row[0]))
       container_x.append(float(row[0]))
with open('C:\\Users\Shashi Suman\Desktop\Data Analytics\Longitude_701.csv','rt') as l:
    data=csv.reader(l)
    for row in data:
...
gmp.scatter(lat2, long2, 'blue',size=40, marker=False)
...
gmp.draw("C:\\Users\Shashi Suman\Desktop\Data Analytics\Kingston - Google Maps18-21_park.html")
