...
with open('C:\\Users\Shashi Suman\Desktop\Data Analytics\Latitude_7.csv','rt') as l:
    data=csv.reader(l)
    for row in data:
       lat.append(float(row[0]))
       container_x.append(float(row[0]))
with open('C:\\Users\Shashi Suman\Desktop\Data Analytics\Longitude_7.csv','rt') as l:
    data=csv.reader(l)
    for row in data:
       long.append(float(row[0]))
       container_y.append(float(row[0]))

with open('C:\\Users\Shashi Suman\Desktop\Data Analytics\Latitude_8.csv','rt') as l:
    data=csv.reader(l)
    for row in data:
       lat1.append(float(row[0]))
       container_x.append(float(row[0]))
with open('C:\\Users\Shashi Suman\Desktop\Data Analytics\Longitude_8.csv','rt') as l:
    data=csv.reader(l)
    for row in data:
       long1.append(float(row[0]))
       container_y.append(float(row[0]))
with open('C:\\Users\Shashi Suman\Desktop\Data Analytics\Latitude_10.csv','rt') as l:
    data=csv.reader(l)
    for row in data:
       lat2.append(float(row[0]))
       container_x.append(float(row[0]))
with open('C:\\Users\Shashi Suman\Desktop\Data Analytics\Longitude_10.csv','rt') as l:
    data=csv.reader(l)
    for row in data:
       long2.append(float(row[0]))
       container_y.append(float(row[0]))
with open('C:\\Users\Shashi Suman\Desktop\Data Analytics\Latitude_11.csv','rt') as l:
    data=csv.reader(l)
    for row in data:
       lat3.append(float(row[0]))
       container_x.append(float(row[0]))
with open('C:\\Users\Shashi Suman\Desktop\Data Analytics\Longitude_11.csv','rt') as l:
    data=csv.reader(l)
    for row in data:
...
gmp.draw("C:\\Users\Shashi Suman\Desktop\Data Analytics\Kingston - Google Maps10-13_park.html")
